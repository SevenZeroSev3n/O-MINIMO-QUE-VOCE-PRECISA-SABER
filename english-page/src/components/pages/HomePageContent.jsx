...
const HomePageContent = () => {
    ...
    <section className={styles.hero}>
      ...
      <aside className={styles.heroSideCard} id="formulario">
        ...
        <form id="leadForm" className={styles.leadForm}>
          ...
          <div className={`${styles.leadFormGrid} ${styles.leadFormGrid2}`}>
            ...
            <div className={styles.leadField}>
              ...
              <select id="nivel" name="nivel" className={styles.leadSelect} required>
          ...
          <div className={`${styles.leadFormGrid} ${styles.leadFormGrid2}`}>
            <div className={styles.leadField}>
              ...
              <select id="objetivo" name="objetivo" className={styles.leadSelect} required>
                <option value="">Selecione</option>
            ...
            <div className={styles.leadField}>
              ...
              <select id="horario" name="horario" className={styles.leadSelect} required>
                <option value="">Selecione</option>
                <option>Manhã</option>
                <option>Tarde</option>
                <option>Noite</option>
          ...
          <div id="leadError" className={styles.leadError}>
            Preenche os campos obrigatórios antes de enviar. 🙏
          </div>

          <button type="submit" className={`btn btn-primary ${styles.leadSubmit}`}>
